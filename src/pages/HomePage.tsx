...
const HomePage = () => {
  ...
  const handleSearch = async (checkInDate: string, checkOutDate: string, guestCount: number) => {
    ...
    try {
      ...
      const response = await fetch('/proxy/rooms/check-availability', {
        method: 'POST',
        headers: {
                        ...
                        src={
                          room.main_image?.url 
                            ? room.main_image.url.startsWith('http') 
                              ? room.main_image.url 
                              : `/proxy/storage/${room.main_image.url}`
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-2xl font-medium text-muted-foreground bg-secondary/50 hover:bg-secondary transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-2xl font-medium text-white bg-primary hover:bg-primary/90 transition-colors group/btn"
                        >
                          <span>Book</span>
